...
public class FamilyTree {
    ...
    private void addLine(String line) throws TreeException {
        ...
        if (root == null)
            ...
            if (parentNode == null)
                throw new TreeException("Error in file");
        }
    ...
    TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException {
        ...
        if (node1 == null)
            throw new TreeException("name1 not found. Try another name.");// Throw a TreeException with a useful message
        TreeNode node2 = root.getNodeWithName(name2); // node whose name is name2
        if (node2 == null)
            throw new TreeException("name2 not found. Try another name."); // Throw TreeException with a useful message
